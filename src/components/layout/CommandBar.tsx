...
export function CommandBar({
  ...
  const suggestionList = workspaceMode
    ? [...WORKSPACE_SUGGESTIONS, ...SUGGESTIONS.slice(0, 3)]
    : SUGGESTIONS;
  ...
  return (
    ...
    >
      ...
      <div
        className={
          isEmpty ? "w-full max-w-xl" : "w-full backdrop-blur-md bg-white/30"
        }
      >
        <AnimatePresence>
          {aiMessage && (
